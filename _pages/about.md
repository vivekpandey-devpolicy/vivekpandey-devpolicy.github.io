...
He has collaborated with major funding agencies including the World Bank, Bill & Melinda Gates Foundation (BMGF), UNICEF, and Ford Foundation, raising nearly USD three million in external grants. His teaching interests include Causal AI and Machine Learning, Designing Development and Agri-Food Interventions, and Field Experiments for Social Policy. At IRMA, Vivek led the research initiatives at the Verghese Kurien Policy Lab (VKPL) since 2019, and also served as the Dean (Faculty) before joining IIM Ahmedabad in December 2025.
